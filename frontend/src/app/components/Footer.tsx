...
export function Footer() {
  return (
    <footer  className="text-white bg-[#0EA5E9]" id="contact">
            ...
            <div className="flex gap-4">
              {socialLinks.map((social, index) => (
                <a
                  key={index}
                  href={social.href}
                  className="w-10 h-10 rounded-full bg-white text-[#0EA5E9] hover:translate-0.5 hover:text-white hover:ring-1 hover:bg-[#0EA5E9] flex items-center justify-center duration-300 transition-all"
